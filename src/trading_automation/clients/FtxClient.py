...
class FtxClient:
    ...
    def __init__(self, base_url=None, api_key=None, api_secret=None, subaccount_name=None, timeout=0.3) -> None:
    ...
    @authentication_required
    def get_order_by_client_id(self, client_order_id: str = None) -> dict:
        return self._get(f'orders/by_client_id/{client_order_id}')

    @authentication_required
    def get_order_by_order_id(self, order_id) -> dict:
    ...
    def get_conditional_order_history(self, market: str = None, side: str = None, type: str = None,
                                      order_type: str = None, start_time: float = None, end_time: float = None) -> List[dict]:
    ...
    @authentication_required
    def latency_stats(self, days=1, subaccount_nickname="_main") -> List[dict]:
        return self._get(f'/stats/latency_stats', {'days': days, 'subaccount_nickname': {subaccount_nickname}})
