"""
from https://github.com/Bitrue-exchange/Bitrue-future-SDK/blob/main/futures_api_example_python/bitrue/future_client.py
"""
# coding=utf-8
import hashlib
import hmac
...
class BitrueClient(object):
    ...
    def _reqeust(self, method, uri, signed, force_params=False, **kwargs):
        ...
        if signed:
            ...
            headers['X-CH-SIGN'] = self._generate_signature(ts, method, path, params=kwargs.get('params', {}),
                                                            payload=a_payload)
        # print(headers)
    ...
    def get_klines(self, **params):
        # NOTE: does not get the most current incomplete candle
